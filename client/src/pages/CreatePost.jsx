...
export default function CreatePost() {
  ...
  const [videoFile, setVideoFile] = useState(null); // État pour le fichier vidéo
  const [imageUploadProgress, setImageUploadProgress] = useState(null);
  const [videoUploadProgress, setVideoUploadProgress] = useState(null); // État pour l'avancement de téléchargement vidéo
  const [imageUploadError, setImageUploadError] = useState(null);
  const [videoUploadError, setVideoUploadError] = useState(null); // État pour les erreurs de téléchargement vidéo
